...
public class ControlOfEye extends ControlOf {
	...
	ControlOfEye(SceneControler sceneControler, String name) {
	...
	public void setup() {
		...
		Point3D center = new Point3D(sceneControler.camera.position);
		...
		eyeAtButton.addActionListener(sceneControler);
