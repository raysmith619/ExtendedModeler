...
public class ControlOfView extends JDialog implements java.awt.event.WindowListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	SceneViewer sceneViewer;	// Our scene
	...
	ControlOfView(SceneViewer sceneViewer, String name) {
		super();
	...
	public void setControl(boolean on) {
			...
			bindex = sceneViewer.getSelectedBlockIndex();
	...
	/**
	 * Update position in sceneViewer display
	 */
	void updatePosition() {
	 ...
	 */
 	...
 	public void dispose() {
  		super.dispose();
		sceneViewer.setCheckBox(name, false);			// Clear display checkbox
 		setup = false;
	}
